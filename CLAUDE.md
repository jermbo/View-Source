...
See [CONTEXT.md](./CONTEXT.md) for the domain glossary (World, Project, Page, UI Kit, Escape Hatch) and `docs/adr/` for architectural decisions.
...
More will be added here as they come up — check this file before assuming a pattern needs re-explaining.
